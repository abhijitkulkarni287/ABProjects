...
$(document).ready(function(){
  $("#startTestBtn").click(function(){
    $.ajax({url:"http://localhost:8091/Exam_System_010/test/fetchQuestion.hr?examId="+examId, success: function(result){
    data=result;
...
<br>
 ...
 <input type="button"  id="nextQuestion" onclick="return getRadioValue()" value="SAVE ANSWER" >
 <br>
 <br>
 <br>
</form>
...
<input type=submit  class='button1'  onclick="return submitTest()" value="Submit" />  
</form>
</div>
